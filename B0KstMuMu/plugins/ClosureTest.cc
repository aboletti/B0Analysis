...
void loadEffHisto(unsigned int q2bin) {
  ...
  cout << "Try to get " << Form("pdf_ctKctLphi_2D_q2bin%d",q2bin) ;
...
void initHisto(int q2bin) {
  h_reco_ctk_ctl_phi1[q2bin-1] = new TH2F(Form("h_reco_ctk_ctl_phi1_%i",q2bin-1),Form("h_reco_ctk_ctl_phi1_%i",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_reco_ctk_ctl_phi2[q2bin-1] = new TH2F(Form("h_reco_ctk_ctl_phi2_%i",q2bin-1),Form("h_reco_ctk_ctl_phi2_%i",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_reco_ctk_ctl_phi3[q2bin-1] = new TH2F(Form("h_reco_ctk_ctl_phi3_%i",q2bin-1),Form("h_reco_ctk_ctl_phi3_%i",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_reco_ctk_ctl_phi4[q2bin-1] = new TH2F(Form("h_reco_ctk_ctl_phi4_%i",q2bin-1),Form("h_reco_ctk_ctl_phi4_%i",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_gen_ctk_ctl_phi1[q2bin-1] = new TH2F(Form("h_gen_ctk_ctl_phi1_%i",q2bin-1),Form("h_gen_ctk_ctl_phi1_%i",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_gen_ctk_ctl_phi2[q2bin-1] = new TH2F(Form("h_gen_ctk_ctl_phi2_%i",q2bin-1),Form("h_gen_ctk_ctl_phi2_%i",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_gen_ctk_ctl_phi3[q2bin-1] = new TH2F(Form("h_gen_ctk_ctl_phi3_%i",q2bin-1),Form("h_gen_ctk_ctl_phi3_%i",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_gen_ctk_ctl_phi4[q2bin-1] = new TH2F(Form("h_gen_ctk_ctl_phi4_%i",q2bin-1),Form("h_gen_ctk_ctl_phi4_%i",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_diff_ctk_ctl_phi1[q2bin-1] = new TH2F(Form("h_diff_ctk_ctl_phi1_%i",q2bin-1),Form("h_diff_ctk_ctl_phi1_%i;cos#theta_{K};cos#theta_{L}",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_diff_ctk_ctl_phi2[q2bin-1] = new TH2F(Form("h_diff_ctk_ctl_phi2_%i",q2bin-1),Form("h_diff_ctk_ctl_phi2_%i;cos#theta_{K};cos#theta_{L}",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_diff_ctk_ctl_phi3[q2bin-1] = new TH2F(Form("h_diff_ctk_ctl_phi3_%i",q2bin-1),Form("h_diff_ctk_ctl_phi3_%i;cos#theta_{K};cos#theta_{L}",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_diff_ctk_ctl_phi4[q2bin-1] = new TH2F(Form("h_diff_ctk_ctl_phi4_%i",q2bin-1),Form("h_diff_ctk_ctl_phi4_%i;cos#theta_{K};cos#theta_{L}",q2bin-1),10,-1.,1.,10,-1.,1.);
  h_gen_ctk [q2bin-1] = new TH1F(Form("h_gen_ctk%i",q2bin-1) ,Form("h_gen_ctk%i;cos#theta_{K}",q2bin-1) ,100,-1.,1.);
  h_reco_ctk[q2bin-1] = new TH1F(Form("h_reco_ctk%i",q2bin-1),Form("h_reco_ctk%i;cos#theta_{K}",q2bin-1),100,-1.,1.);
  h_gen_ctl [q2bin-1] = new TH1F(Form("h_gen_ctl%i",q2bin-1) ,Form("h_gen_ctl%i;cos#theta_{L}",q2bin-1) ,100,-1.,1.);
  h_reco_ctl[q2bin-1] = new TH1F(Form("h_reco_ctl%i",q2bin-1),Form("h_reco_ctl%i;cos#theta_{L}",q2bin-1),100,-1.,1.);
  h_gen_phi [q2bin-1] = new TH1F(Form("h_gen_phi%i",q2bin-1) ,Form("h_gen_phi%i;#phi",q2bin-1)          ,100,-TMath::Pi(),TMath::Pi());
  h_reco_phi[q2bin-1] = new TH1F(Form("h_reco_phi%i",q2bin-1),Form("h_reco_phi%i;#phi",q2bin-1)         ,100,-TMath::Pi(),TMath::Pi());
}
...
void fillHistoGen(int q2bin) {
  ...
  else if (NTupleIn_gen->PhiKstMuMuPlaneArb < 0)               h_gen_ctk_ctl_phi2[q2bin-1]->Fill(NTupleIn_gen->CosThetaKArb,NTupleIn_gen->CosThetaMuArb,weight*nweight);
  else if (NTupleIn_gen->PhiKstMuMuPlaneArb < 0.5*TMath::Pi()) h_gen_ctk_ctl_phi3[q2bin-1]->Fill(NTupleIn_gen->CosThetaKArb,NTupleIn_gen->CosThetaMuArb,weight*nweight);
  else                                                         h_gen_ctk_ctl_phi4[q2bin-1]->Fill(NTupleIn_gen->CosThetaKArb,NTupleIn_gen->CosThetaMuArb,weight*nweight);
  h_gen_ctk[q2bin-1]->Fill(NTupleIn_gen->CosThetaKArb,       weight*nweight);
  h_gen_ctl[q2bin-1]->Fill(NTupleIn_gen->CosThetaMuArb,      weight*nweight);
  h_gen_phi[q2bin-1]->Fill(NTupleIn_gen->PhiKstMuMuPlaneArb, weight*nweight);
  gen_cnt++;
}

void fillHistoReco(int q2bin ) {
  ...
  /*if (!( (NTupleIn_reco->truthMatchSignal->at(0) == true) &&
	 (NTupleIn_reco->rightFlavorTag == Utility->RIGHTflavorTAG) &&
	 ...
	 (Utility->PsiRejection(NTupleIn_reco->B0MassArb,NTupleIn_reco->mumuMass->at(0),NTupleIn_reco->mumuMassE->at(0),"rejectPsi",true) == true) ) ) return;*/

  if (NTupleIn_reco->PhiKstMuMuPlaneArb < -0.5*TMath::Pi())     h_reco_ctk_ctl_phi1[q2bin-1]->Fill(NTupleIn_reco->CosThetaKArb,NTupleIn_reco->CosThetaMuArb);
  else if (NTupleIn_reco->PhiKstMuMuPlaneArb < 0)               h_reco_ctk_ctl_phi2[q2bin-1]->Fill(NTupleIn_reco->CosThetaKArb,NTupleIn_reco->CosThetaMuArb);
  else if (NTupleIn_reco->PhiKstMuMuPlaneArb < 0.5*TMath::Pi()) h_reco_ctk_ctl_phi3[q2bin-1]->Fill(NTupleIn_reco->CosThetaKArb,NTupleIn_reco->CosThetaMuArb);
  else                                                          h_reco_ctk_ctl_phi4[q2bin-1]->Fill(NTupleIn_reco->CosThetaKArb,NTupleIn_reco->CosThetaMuArb);
  h_reco_ctk[q2bin-1]->Fill(NTupleIn_reco->CosThetaKArb);
  h_reco_ctl[q2bin-1]->Fill(NTupleIn_reco->CosThetaMuArb);
  h_reco_phi[q2bin-1]->Fill(NTupleIn_reco->PhiKstMuMuPlaneArb);
  reco_cnt++;
}
...
void plotTestHisto(int q2bin) {
  ...
  for (int i=1; i<=h_diff_ctk_ctl_phi1[q2bin-1]->GetXaxis()->GetNbins(); i++) for (int j=1; j<=h_diff_ctk_ctl_phi1[q2bin-1]->GetYaxis()->GetNbins(); j++) {
      h_diff_ctk_ctl_phi1[q2bin-1]->SetBinContent(i, j, (h_gen_ctk_ctl_phi1[q2bin-1]->GetBinContent(i,j)-h_reco_ctk_ctl_phi1[q2bin-1]->GetBinContent(i,j))/((h_gen_ctk_ctl_phi1[q2bin-1]->GetBinContent(i,j)+h_reco_ctk_ctl_phi1[q2bin-1]->GetBinContent(i,j))>0.001?(h_gen_ctk_ctl_phi1[q2bin-1]->GetBinContent(i,j)+h_reco_ctk_ctl_phi1[q2bin-1]->GetBinContent(i,j)):0.001));
      h_diff_ctk_ctl_phi2[q2bin-1]->SetBinContent(i, j, (h_gen_ctk_ctl_phi2[q2bin-1]->GetBinContent(i,j)-h_reco_ctk_ctl_phi2[q2bin-1]->GetBinContent(i,j))/((h_gen_ctk_ctl_phi2[q2bin-1]->GetBinContent(i,j)+h_reco_ctk_ctl_phi2[q2bin-1]->GetBinContent(i,j))>0.001?(h_gen_ctk_ctl_phi2[q2bin-1]->GetBinContent(i,j)+h_reco_ctk_ctl_phi2[q2bin-1]->GetBinContent(i,j)):0.001));
      h_diff_ctk_ctl_phi3[q2bin-1]->SetBinContent(i, j, (h_gen_ctk_ctl_phi3[q2bin-1]->GetBinContent(i,j)-h_reco_ctk_ctl_phi3[q2bin-1]->GetBinContent(i,j))/((h_gen_ctk_ctl_phi3[q2bin-1]->GetBinContent(i,j)+h_reco_ctk_ctl_phi3[q2bin-1]->GetBinContent(i,j))>0.001?(h_gen_ctk_ctl_phi3[q2bin-1]->GetBinContent(i,j)+h_reco_ctk_ctl_phi3[q2bin-1]->GetBinContent(i,j)):0.001));
      h_diff_ctk_ctl_phi4[q2bin-1]->SetBinContent(i, j, (h_gen_ctk_ctl_phi4[q2bin-1]->GetBinContent(i,j)-h_reco_ctk_ctl_phi4[q2bin-1]->GetBinContent(i,j))/((h_gen_ctk_ctl_phi4[q2bin-1]->GetBinContent(i,j)+h_reco_ctk_ctl_phi4[q2bin-1]->GetBinContent(i,j))>0.001?(h_gen_ctk_ctl_phi4[q2bin-1]->GetBinContent(i,j)+h_reco_ctk_ctl_phi4[q2bin-1]->GetBinContent(i,j)):0.001));
    }

  c_ctest[q2bin-1] = new TCanvas(Form("c_ctest%i",q2bin-1),Form("c_ctest%i",q2bin-1),800,800);
  c_ctest[q2bin-1]->Divide(2,2);
  c1_ctest[q2bin-1] = new TCanvas(Form("c1_ctest%i",q2bin-1),Form("c1_ctest%i",q2bin-1),800,800);
  c1_ctest[q2bin-1]->Divide(2,2);
...
void performTest(int q2bin, int nev_reco=0, int nev_gen=0, bool doPlot=true) {
  initHisto(q2bin);

  TFile* NtplFileIn_reco = TFile::Open("dcap://t2-srm-02.lnl.infn.it//pnfs/lnl.infn.it/data/cms/store/user/slacapra/B0KsMuMu/Data2012B0KstMuMuResults/MonteCarlo2012/SingleCand/singleCand_B0ToKstMuMu_MC_NTuple.root", "READ");
  ...
  TFile* NtplFileIn_gen = TFile::Open("dcap://t2-srm-02.lnl.infn.it//pnfs/lnl.infn.it/data/cms/store/user/slacapra/B0KsMuMu/Data2012B0KstMuMuResults/MonteCarlo2012/ForEfficiency/B0ToKstMuMu_GEN_NoFilter_MC_NTuples_addGENvars.root","READ");
...
int main(int argc, char** argv)
{
  if (argc > 0)
	...
	Utility = new Utils(false);
      ...
      if ( argc > 4 ) nev_gen = atoi(argv[4]);
      if ( argc > 5 ) nev_reco = atoi(argv[5]);
